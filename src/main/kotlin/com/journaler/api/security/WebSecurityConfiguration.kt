...
class WebSecurityConfiguration : WebSecurityConfigurerAdapter() {
  ...
  /**
   * Tej zmiennej będzie przypisana instancja klasy WebSecurityEntryPoint.
   */
  @Autowired
  ...
  override fun configure(http: HttpSecurity?) {
    http
      ...
      ?.authorizeRequests()
      /**
       * Dostęp do notatek i zadań jest udzielany każdemu uwierzytelnionemu użytkownikowi.
       */
      ...
      ?.antMatchers("/todos/**")?.authenticated()
      /**
       * Dostęp do kont użytkowników jest udzielany tylko administratorowi.
       * */
